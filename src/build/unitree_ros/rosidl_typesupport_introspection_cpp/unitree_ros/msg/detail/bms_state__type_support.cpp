...
{
  new (message_memory) unitree_ros::msg::BmsState(_init);
}

void BmsState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_ros::msg::BmsState *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<uint16_t, 10> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<uint16_t, 10> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BmsState_message_member_array[9] = {
  {
    ...
    offsetof(unitree_ros::msg::BmsState, version_h),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_ros::msg::BmsState, version_l),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_ros::msg::BmsState, bms_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_ros::msg::BmsState, soc),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_ros::msg::BmsState, current),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_ros::msg::BmsState, cycle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(unitree_ros::msg::BmsState, bq_ntc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(unitree_ros::msg::BmsState, mcu_ntc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    10,  // array size
    false,  // is upper bound
    offsetof(unitree_ros::msg::BmsState, cell_vol),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BmsState_message_members = {
  ...
  9,  // number of fields
  sizeof(unitree_ros::msg::BmsState),
...
{
  return &::unitree_ros::msg::rosidl_typesupport_introspection_cpp::BmsState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_ros, msg, BmsState)() {
  return &::unitree_ros::msg::rosidl_typesupport_introspection_cpp::BmsState_message_type_support_handle;
}
