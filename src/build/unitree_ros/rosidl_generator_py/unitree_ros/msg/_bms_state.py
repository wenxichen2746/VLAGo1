...
class Metaclass_BmsState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('unitree_ros')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'unitree_ros.msg.BmsState')
            logger.debug(
...
class BmsState(metaclass=Metaclass_BmsState):
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('int8'), 2),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('uint16'), 10),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.version_h = kwargs.get('version_h', int())
        self.version_l = kwargs.get('version_l', int())
        self.bms_status = kwargs.get('bms_status', int())
        ...
        if 'cell_vol' not in kwargs:
            self.cell_vol = numpy.zeros(10, dtype=numpy.uint16)
        else:
            self.cell_vol = numpy.array(kwargs.get('cell_vol'), dtype=numpy.uint16)
            assert self.cell_vol.shape == (10, )
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.version_h != other.version_h:
            return False
        if self.version_l != other.version_l:
            return False
        if self.bms_status != other.bms_status:
            return False
    ...
    @builtins.property
    def version_h(self):
        """Message field 'version_h'."""
        return self._version_h

    @version_h.setter
    def version_h(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'version_h' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'version_h' field must be an unsigned integer in [0, 255]"
        self._version_h = value

    @builtins.property
    def version_l(self):
        """Message field 'version_l'."""
        return self._version_l

    @version_l.setter
    def version_l(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'version_l' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'version_l' field must be an unsigned integer in [0, 255]"
        self._version_l = value

    @builtins.property
    def bms_status(self):
        """Message field 'bms_status'."""
        return self._bms_status

    @bms_status.setter
    def bms_status(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'bms_status' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'bms_status' field must be an unsigned integer in [0, 255]"
        ...
        if self._check_fields:
            if isinstance(value, numpy.ndarray):
                ...
                assert value.size == 10, \
                    "The 'cell_vol' numpy.ndarray() must have a size of 10"
            ...
            assert \
                ...
                "The 'cell_vol' field must be a set or sequence with length 10 and each value of type 'int' and each unsigned integer in [0, 65535]"
