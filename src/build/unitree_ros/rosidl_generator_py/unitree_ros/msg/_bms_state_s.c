...
bool unitree_ros__msg__bms_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_ros.msg._bms_state.BmsState", full_classname_dest, 35) == 0);
  }
  unitree_ros__msg__BmsState * ros_message = _ros_message;
  {  // version_h
    PyObject * field = PyObject_GetAttrString(_pymsg, "version_h");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->version_h = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // version_l
    PyObject * field = PyObject_GetAttrString(_pymsg, "version_l");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->version_l = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bms_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms_status");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bms_status = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // soc
...
PyObject * unitree_ros__msg__bms_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_ros.msg._bms_state");
  ...
  {  // version_h
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->version_h);
    {
      int rc = PyObject_SetAttrString(_pymessage, "version_h", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // version_l
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->version_l);
    {
      int rc = PyObject_SetAttrString(_pymessage, "version_l", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bms_status
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bms_status);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cell_vol
    ...
    memcpy(dst, src, 10 * sizeof(uint16_t));
    Py_DECREF(field);
  }
