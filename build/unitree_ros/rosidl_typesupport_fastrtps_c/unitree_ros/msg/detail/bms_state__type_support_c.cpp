...
#include "unitree_ros/msg/detail/bms_state__rosidl_typesupport_fastrtps_c.h"
...
using _BmsState__ros_msg_type = unitree_ros__msg__BmsState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: version_h
  {
    cdr << ros_message->version_h;
  }

  // Field name: version_l
  {
    cdr << ros_message->version_l;
  }

  // Field name: bms_status
  {
...
size_t get_serialized_size_unitree_ros__msg__BmsState(
  const void * untyped_ros_message,
...
static uint32_t _BmsState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_ros__msg__BmsState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_ros
size_t max_serialized_size_unitree_ros__msg__BmsState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_ros__msg__BmsState;
    is_plain =
      (
...
static size_t _BmsState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_ros__msg__BmsState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_ros, msg, BmsState)() {
